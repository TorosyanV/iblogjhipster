package am.iblog.application.web.rest;

import am.iblog.application.config.Constants;
import am.iblog.application.IblogjhipsterApp;
import am.iblog.application.domain.Authority;
import am.iblog.application.domain.User;
import am.iblog.application.repository.AuthorityRepository;
import am.iblog.application.repository.UserRepository;
import am.iblog.application.security.AuthoritiesConstants;
import am.iblog.application.service.MailService;
import am.iblog.application.service.dto.UserDTO;
import am.iblog.application.web.rest.errors.ExceptionTranslator;
import am.iblog.application.web.rest.vm.KeyAndPasswordVM;
import am.iblog.application.web.rest.vm.ManagedUserVM;
import am.iblog.application.service.UserService;
...
@SpringBootTest(classes = IblogjhipsterApp.class)
